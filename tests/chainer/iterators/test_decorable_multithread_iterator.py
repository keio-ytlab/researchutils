import pytest
from researchutils.chainer.iterators import decorable_multithread_iterator


class TestDecorableMultithreadIterator(object):
    def test_next_repeat_no_shuffle(self):
        dataset = [data for data in range(50)]
        batch_size = 16
        iterator = decorable_multithread_iterator.DecorableMultithreadIterator(dataset=dataset,
